...
const CartDetails = () => {
    ...
    const cartProducts = cart.products.map((element) => {
        // const selectProduct = useSelector((state) => allProductsSelector.selectById(state, element.id));
        return (
            <tr>
                ...
                <td className="text-center border-0 align-middle"><strong>${element.discountedPrice}</strong></td>
                <td className="text-center border-0 align-middle"><strong>{element.quantity}</strong></td>
                <td className="text-center border-0 align-middle"><a href="#" className="text-dark"><i className="fa fa-trash"></i></a></td>
            </tr>
        );
    })
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="p-4">
                                    ...
                                    <ul className="list-unstyled mb-4">
                                        <li className="col-sm-12 d-flex justify-content-between py-3 border-bottom"><strong className="text-muted">Order Subtotal </strong><strong>${cart.total}</strong></li>

                                        <li className="col-sm-12 d-flex justify-content-between py-3 border-bottom"><strong className="text-muted">Discount</strong><strong>${cart.total - cart.discountedTotal}</strong></li>
                                        ...
                                        <li className="col-sm-12 d-flex justify-content-between py-3 border-bottom"><strong className="text-muted">Grand Total</strong>
                                            <h5 className="font-weight-bold">${cart.discountedTotal + 10}</h5>
                                        </li>
